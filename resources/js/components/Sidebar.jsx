    ...
    >
      <nav className="h-full text-white flex flex-col bg-pink-300 border-r shadow-sm">
        ...
        <ul className="flex-1 px-3 mt-2">
          ...
          <SidebarItem href="/riwayat" icon={<img src={RiwayatIcon} className="w-6" />} text="Riwayat Transaksi" />
          <SidebarItem href="/laporan" icon={<img src={Keuangan} className="w-6" />} text="Laporan Keuangan" />
        </ul>
