  ...
  return (
    <div className="bg-pink-100 flex items-center justify-between px-6 py-4 shadow-md">
      ...
      <div className="flex-1 max-w-xs mx-6 relative">
        <input type="search" placeholder="Cari sesuatu..." value={keyword} onChange={handleSearch}
      ...
      <Link to="/Profile"
        className="flex items-center gap-3 bg-white px-5 py-2 rounded-lg shadow-md border border-pink-100 hover:shadow-lg transition duration-200">
