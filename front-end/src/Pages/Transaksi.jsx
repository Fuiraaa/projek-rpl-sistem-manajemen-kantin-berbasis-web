...
import ayambakar from "../assets/mayambakar.png";
import ayamgoreng from "../assets/mayamgoreng.png";
import ayamkecap from "../assets/mayamkecap.png";
import atiampela from "../assets/matiampela.png";
import telurbalado from "../assets/mtelurbalado.png";
import telurgoreng from "../assets/mtelurgoreng.png";
import sosistelur from "../assets/msosistelur.png";
import pisangcokelat from "../assets/mpisangcokelat.png";
import tempegoreng from "../assets/mtempegoreng.png";
import nasigoreng from "../assets/mnasigoreng.png";
import indomie from "../assets/mindomie.png";
import micelor from "../assets/micelor.png";
import mikariayam from "../assets/mikariayam.png";
import mikriuk from "../assets/migorengkriuk.png";
import mirendang from "../assets/mirendang.png";
import micabeijo from "../assets/micabeijo.png";
import leminerale from "../assets/mleminerale.png";
import goodday from "../assets/mgoodday.png";
import chocolatos from "../assets/mchocolatos.png";
import milo from "../assets/milo.png";
import drinkbengbeng from "../assets/mdrinkbengbeng.png";
import frisianflag from "../assets/mfrisianflag.png";
import tehsisri from "../assets/mtehsisri.png";
import teajus from "../assets/mteajus.png";
import hilo from "../assets/mhilo.png";
import popes from "../assets/mpopes.png";
        ...
        <div className="flex w-full h-screen gap-4 p-4">
            ...
            {cart.length > 0 && (
                <div className="w-[32%] bg-white rounded-lg shadow-md p-4 flex flex-col">
                    ...
                    <div className="mt-96 pt-6 mb-1 bg-pink-50 border-t flex items-center justify-between gap-2">
                        <div>
