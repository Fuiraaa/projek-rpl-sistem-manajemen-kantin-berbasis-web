...
class TransaksiController extends Controller
{
    ...
    {
        // ✅ HANYA AMBIL DATA USER YANG SEDANG LOGIN
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            foreach ($validated['items'] as $item) {
                ...
                Log::info('Transaksi Detail Created:', $transaksiDetail->toArray());
            ...
            Log::info('✅ Transaction completed successfully - ID: ' . $transaksi->transaksi_id);
